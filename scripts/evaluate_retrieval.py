...
def main() -> None:
    ...
    parser.add_argument('--min-recall', type=unit_interval); parser.add_argument('--min-mrr', type=unit_interval); parser.add_argument('--min-negative-accuracy', type=unit_interval)
