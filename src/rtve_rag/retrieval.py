...
def search(query:str, client:QdrantClient, collection:str, ollama_url:str='http://localhost:11434', model:str='qwen3-embedding:0.6b', top_k:int=4, program:str|None=None, emission_date:str|None=None, language:str|None=None)->list[dict]:
    filters=[]
    ...
    vector=embed([query],ollama_url,model)[0]
